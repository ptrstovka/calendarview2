...
public class DynamicSettersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentTileSize = CalendarView2.DEFAULT_TILE_SIZE_DP;
    ...
    void onOtherDatesClicked() {
        ...
        final int[] itemValues = {
                CalendarView2.SHOW_OTHER_MONTHS,
                CalendarView2.SHOW_OUT_OF_RANGE,
                CalendarView2.SHOW_DECORATED_DISABLED,
        };
        int showOtherDates = widget.getShowOtherDates();

        boolean[] initSelections = {
                CalendarView2.showOtherMonths(showOtherDates),
                CalendarView2.showOutOfRange(showOtherDates),
                CalendarView2.showDecoratedDisabled(showOtherDates),
    ...
    void onTextAppearanceChecked(boolean checked) {
        ...
        widget.setShowOtherDates(checked ? CalendarView2.SHOW_ALL : CalendarView2.SHOW_NONE);
    }
    ...
    void onButtonChangeOrientation() {
        widget.setTitleAnimationOrientation(
                widget.getTitleAnimationOrientation() == CalendarView2.VERTICAL
                        ? CalendarView2.HORIZONTAL
                        : CalendarView2.VERTICAL);
